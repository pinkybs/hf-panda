...
define('HOST', 'http://testipanda-taobao.happyfish001.com');
define('STATIC_HOST', 'http://testipandastatic.happyfish001.com/taobao');

define('SEND_ACTIVITY', true);
define('SEND_MESSAGE', false);

define('APP_STATUS', 1);
define('APP_STATUS_DEV', 2); //1 正服  2 测服 3 开发服 4 本地开发
