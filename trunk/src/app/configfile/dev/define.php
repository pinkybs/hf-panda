...
define('LOG_DIR', '/home/admin/logs/ipanda/taobao/debug');
...
define('MEMCACHED_NODE_NUM', 2);
define('USE_CACHE', 1);

define('HOST', 'http://devipandataobao.happyfish001.com');
define('STATIC_HOST', 'http://devstaticipanda.happyfish001.com/taobao');

define('SEND_ACTIVITY', true);
define('SEND_MESSAGE', false);

define('APP_STATUS', 1);
define('APP_STATUS_DEV', 4); //1 正服  2 测服 3 开发服 4 本地开发
