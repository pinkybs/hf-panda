...
class Hapyfish2_Ipanda_Stat_Dal_ActiveUserLevel
{
    protected static $_instance;
    
    private $_tb_day_active_user_level = 'day_active_user_level';
    private $_tb_day_user_level = 'day_user_level';

    /**
     * Single Instance
     *
     * @return Hapyfish2_Ipanda_Stat_Dal_ActiveUserLevel
     */
    ...
    public function getDayUserList($day)
    {
        $tbname = $this->_tb_day_user_level;
        $sql = "SELECT * FROM $tbname WHERE log_time=:day";
