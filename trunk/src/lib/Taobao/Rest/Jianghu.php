...
class Taobao_Rest_Jianghu extends Taobao_Rest_Abstract
{
    ...
    public function fan_follow($shop_owner_id)
    {
        $params = array('shop_owner_id' => $shop_owner_id);
        return $this->call_method('taobao.jianghu.fan.follow', $params);
    }
    
    public function fan_check($shop_owner_id, $follower_id)
    {
        $params = array(
            'user_id' => $shop_owner_id,
            'follower_id' => $follower_id
        );
        return $this->call_method('taobao.jianghu.fan.check', $params);
    }
}